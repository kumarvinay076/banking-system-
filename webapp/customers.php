...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn text-center" style="background-color : #FEC107;">Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
         ...
         <p style="color:white;">&copy  Copyright 2021:Made by <b>VINAY</b> </br></p>
        </footer>
